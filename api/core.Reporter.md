...
* `core.Reporter` is a notification reporter, a convenient abstraction to report notifications and subscribe to them
    * **to subscribe** to all notifications, use `addCallback()` method; here's how you can subscribe
        ```lua
        ```
